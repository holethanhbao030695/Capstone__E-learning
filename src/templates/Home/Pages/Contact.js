...
export default function Contact() {
  return (
    <div className="relative bg-white bg-contact ">
        ...
        <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
          ...
          <form action="#" method="POST" className="mt-9 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            <div className="sm:col-span-2">
              <label htmlFor="first-name" className="block text-base font-medium" style={{color:"#97FFFF"}}>
                Họ & tên
              </label>
              <div className="mt-1">
                <input
            ...
            <div className="sm:col-span-2">
              <label htmlFor="email" className="block text-base font-medium" style={{color:"#97FFFF"}}>
                Email
              </label>
              <div className="mt-1">
                <input
            ...
            <div className="sm:col-span-2">
              <div className="flex justify-between">
                <label htmlFor="phone" className="block text-base font-medium" style={{color:"#97FFFF"}}>
                  Điện thoại
                </label>
              </div>
              <div className="mt-1">
            ...
            <div className="sm:col-span-2">
              <div className="flex justify-between">
                <label htmlFor="how-can-we-help" className="block text-base font-medium" style={{color:"#97FFFF"}}>
