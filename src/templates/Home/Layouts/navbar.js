...
export default function Navbar({ toggle }) {
      ...
      return (
        ...
        >
          ...
          >
            ...
            {userSignIn?.maLoaiNguoiDung?.role === "GV" ? (
              ""
            ) : (
              <li>
                <button
  ...
  return (
    <div className="z-10 flex justify-between items-center w-full h-24 lg:fixed top-0 shadow-lg bg-white">
      <nav className="ml-3 sm:ml-5 flex justify-between items-center w-full bg-white text-black font-medium">
        <div className="logo lg:flex-none">
          <NavLink to="/">
            <img style={{ width: '200px' }}
              className="block pl-5 h-auto w-48 lg:hidden"
              src={logo}
              alt="Elearning"
            />
            <img style={{ width: '200px' }}
              className="hidden pl-5 h-auto w-48 lg:block"
              src={logo}
              alt="Elearning"
            />
          </NavLink>
