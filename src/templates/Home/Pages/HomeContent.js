    ...
    <Fragment>
      ...
      <div className="container mx-auto py-5 sm:py-16">
        <div className="heading text-center py-10 sm:py-14">
          <h1 className="text-3xl px-10 sm:text-6xl font-bold py-3">Đào tạo nghề lập trình chuyên sâu từ ZERO</h1>
        ...
        <div className="heading text-center py-14">
          ...
          <p className="text-lg font-normal px-2 mb-24 sm:px-80">
            ...
            bài bản, chuyên nghiệp, chuẩn nghề <br/> ĐH Arizona - USA,
        ...
        <div
          className="mx-5 sm:mx-0 pt-5 grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2 gap-4 place-items-center rounded-3xl bg-gray-100"
        >
          <div className="place-self-auto mb-12 px-5 sm:px-12">
            <h3 className="text-3xl sm:text-6xl font-semibold leading-tight">
            ...
            <NavLink
              to="./signup"
              className=" bg-purple-600 hover:bg-purple-400 hover:text-white  text-white font-semibold text-sm sm:text-base p-4 sm:p-5 rounded-lg transition-colors"
            >
              Đăng ký ngay
            </NavLink>
          </div>
