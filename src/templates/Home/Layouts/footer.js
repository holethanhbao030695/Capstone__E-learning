      ...
      <footer className="px-4 divide-y dark:bg-coolGray-800 dark:text-coolGray-100 ">
        <div className="footer container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            <a href="/" className="flex  justify-start sm:justify-center space-x-3 lg:justify-start">
        ...
        <div className="footer_copyright py-6 text-xl text-center dark:text-coolGray-400">
          © 2022 by - <a href="#">CYBERSOFT</a>
        </div>
      </footer>
    </Fragment>
  );
